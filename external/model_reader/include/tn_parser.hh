...
#include "../src/tn_neuron_interface.h"
...
//  }
    ...
    void initialize_state(tnClass tn);
...
public:
    ...
    void populate_neuron_from_id(unsigned long coreID, unsigned long neuronID, std::unique_ptr<tn_neuron_state> const &n);
    unique_ptr<tn_neuron_state> create_neuron_from_id(unsigned long coreID, unsigned long neuronID);
